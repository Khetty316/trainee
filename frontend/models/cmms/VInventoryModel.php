 ...
 * @property CmmsToolList[] $cmmsToolLists
 */
class VInventoryModel extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['departments'], 'string'],
            [['active_sts', 'inventory_brand_id', 'total_stock_on_hand', 'total_stock_reserved', 'total_stock_available', 'minimum_qty', 'stock_level_sts', 'created_by', 'updated_by'], 'integer'],
    ...
    /**
     * Gets query for [[CmmsToolLists]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getCmmsToolLists()
    {
        return $this->hasMany(CmmsToolList::className(), ['inventory_id' => 'id']);
    }
}
