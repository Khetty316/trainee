...
/**
 * This is the model class for table "v_fab_tasks_masterlist".
 *
 ...
 */
class VFabTasksMasterlist extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'v_fab_tasks_masterlist';
    }
    ...
    public function rules() {
        return [
            ...
            [['fab_assign_percent', 'fab_complete_percent', 'amount', 'assigned_task_qty'], 'number'],
