...
//                                    }
                                    ?>
                                    <?php
                                    $completedTask = $model->taskAssignElecCompletes;
...
//                                                , 'dateFormat' => 'dd/MM/yyyy'])
                                ...
                                <div class="col-12">
                                    <?php
//                                    echo $project_target_date = $task->projProdPanel->projProdMaster->current_target_date;
            ...
            <fieldset class="form-group border p-3">
                ...
                <div  style="max-height: 400px;  overflow:auto" >
                    <table class="table table-sm table-stripped table-bordered" id="myList">
                        ...
                        <tbody>
                            <?php
                            $assignedStaffs = array_column(\yii\helpers\ArrayHelper::toArray($model->taskAssignElecStaff), 'user_id');
...
<script>
    $(function () {
        ...
        $("#taskassignelec-quantity").blur(function (e) {
            let $this = $(this);
        ...
        $("#taskassignelec-quantity").on('focus', function (e) {
            $(this).select();
        })
    });
