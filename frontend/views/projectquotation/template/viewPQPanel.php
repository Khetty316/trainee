...
$this->params['breadcrumbs'][] = ['label' => 'Quotation Templates', 'url' => ['indexpqrevision']];
$this->params['breadcrumbs'][] = ['label' => $model->revisionTemplate->revision_description, 'url' => ['viewpqrevision','id'=>$model->revisionTemplate->id]];
...
<!--            <table class="table table-sm table-borderless">
                <tr class="m-0 p-0">
                    ...
                    <th style="width: 15%" class="text-center px-1 m-0 p-0">
                        <a class="btn btn-success" href="javascript:addItem()">Add <i class="fas fa-plus" ></i></a>
                    </th>
                </tr>
            </table> -->
            <div class="row">
