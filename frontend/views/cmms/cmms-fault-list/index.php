...
<div class="cmms-fault-list-index">
    ...
    //            'reported_by',
                ...
                [
                    ...
                    'value' => function ($model) {
                        if ($model->partList) {
                            return $model->partList->inventory->brand_model;
                        }
                        return '-';
                    },
                ],
                [
                    ...
                    'value' => function ($model) {
                        if ($model->toolList) {
                            return $model->toolList->inventory->brand_model;
                        }
                        return '-';
                    },
                ],
                ...
                <div class="">
                    ...
                    <?php
                        echo Html::a(
                                ...
                                yii\helpers\Url::to('@web/template/template-cmms-fault-list.xls'),
                                [
                                    'class' => 'btn btn-primary mb-5 mt-0',
                                    'download' => 'template-cmms-fault-list.xls',
