...
/**
 * This is the model class for table "ref_covid_places".
 *
 * @property int $id
 ...
 */
class RefCovidPlaces extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'ref_covid_places';
    }
    ...
    public static function getDropDownList() {
        return \yii\helpers\ArrayHelper::map(RefCovidPlaces::find()->orderBy(['order' => SORT_ASC])->all(), "id", "description");
    }
