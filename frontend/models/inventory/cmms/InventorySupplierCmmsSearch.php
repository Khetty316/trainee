...
/**
 * InventorySupplierCmmsSearch represents the model behind the search form of `frontend\models\inventory\cmms\InventorySupplierCmms`.
 */
class InventorySupplierCmmsSearch extends InventorySupplierCmms {
    ...
    public function search($params) {
        $query = InventorySupplierCmms::find();
        ...
        $query->join("LEFT JOIN", "user", "inventory_supplier_cmms.created_by = user.id");
