...
/**
 * This is the model class for table "v_staff_competed_panel_record_fabrication".
 *
 ...
 */
class VStaffCompetedPanelRecordFabrication extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'v_staff_competed_panel_record_fabrication';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['proj_prod_master', 'fab_task_code'], 'required'],
            [['complete_date'], 'safe'],
            ...
            [['staff_id', 'fab_task_code'], 'string', 'max' => 10],
        ];
    }
