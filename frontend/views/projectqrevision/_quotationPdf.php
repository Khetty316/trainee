...
//                        $totalAmtWithSST += $_totAmtWSst
                            ...
                            foreach ($items as $key2 => $item) {
                                ...
                                <tr class="breakdownItem">
                                    ...
                                    if ($panel->by_item_price) {
                                        ...
                                        <td class='br bl'></td>
                                        <td class='br bl'></td>
                                        <td class='br bl text-right p5px'><?= $panel->by_item_price ? number_format($item['amount'], 2) : "" ?></td>
                                        <td class='br bl'></td> 
                                        <?php if ($model->with_sst) { ?>
                                            <td class='br bl'></td>
                                            <?php
        ...
        <table class='table table-sm table-borderless f10 vtop'>
            <tr>
                ...
                <td><?= $model->q_quotation ?></td>
            </tr>
            <tr>
                <td>DELIVERY</td>
                <td>:</td>
                                <!--<td><?php //= (empty($model->q_delivery_ship_mode) ? "" : ($model->q_delivery_ship_mode . "-")) . (empty($model->q_delivery_destination) ? "" : $model->q_delivery_destination . "-" . "-") . $model->q_delivery  ?></td>-->
        ...
        <table class="table table-borderless vtop f9" style="font-family: times">
            ...
            <tr>
                <td class="pt5px" colspan="2">
                    <br/><br/>YOURS FAITHFULLY,<br/><br/>TENAGA KENARI GROUP OF COMPANIES.
                </td>
            </tr>
        </table>
        <br/>
