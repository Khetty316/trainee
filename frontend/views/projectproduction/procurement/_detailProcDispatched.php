...
//$model= frontend\models\ProjectProduction\ProjectProductionPanelProcDispatchMaster::findOne(1);
?>
<div class="row">
    <div class="col-md-5 order-md-2">
        <?= $this->render("/projectproduction/materialbq/_detailViewProjProdDetail", ['projProdMaster' => $model->projProdPanel->projProdMaster, 'panel' => $model->projProdPanel]) ?>
    </div>
