...
<div class="stock-outbound-master-index">
    <div class="table-responsive">
        <?= $this->render('__navbar', ['pageKey' => '2']) ?>
        <p>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($model) {
                        return Html::a($model->dispatch_no, ['dispatch-item-list', 'productionPanelId' => $model->production_panel_id, 'dispatchId' => $model->id, 'status' => 'acknowledged']);
                    }
                ],
                [
