                                ...
                                <?php if (MyCommonFunction::checkRoles([AuthItem::ROLE_Stock_Ob_Super, AuthItem::ROLE_Stock_Ob_Normal])) { ?>
                                    ...
                                    <td class="text-center">
                                        <?php if (!$isFullyDispatched && $detail->active_sts == 1) { ?>
                                            <input type="checkbox" class="select-row" data-master="<?= $keyMaster ?>" data-max-qty="<?= ($detail->qty) - ($detail->unacknowledged_qty + $detail->dispatched_qty) ?>" onclick="fillQuantity(this)">
                                        <?php } ?>
                                    </td>
                                <?php } ?>
                                </tr>
