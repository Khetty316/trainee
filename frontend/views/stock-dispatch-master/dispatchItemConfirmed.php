                        ...
                        <tbody>
                            ...
                            if (!empty($confirmedDispatch)) {
                                foreach ($confirmedDispatch as $key => $dispatch):
                                    ?>
                                    <?php
                                    $detail = \frontend\models\bom\StockOutboundDetails::findOne($dispatch['stock_outbound_details_id']);
                        ...
                        <tbody>
                            ...
                            if (!empty($confirmedAdjust)) {
                                foreach ($confirmedAdjust as $key => $adjust):
                                    ?>
                                    <?php
                                    $detail = \frontend\models\bom\StockOutboundDetails::findOne($adjust['stock_outbound_details_id']);
                        ...
                        <tbody>
                            ...
                            if (!empty($confirmedReturn)) {
                                foreach ($confirmedReturn as $key => $return):
                                    ?>
                                    <?php
                                    $detail = \frontend\models\bom\StockOutboundDetails::findOne($return['stock_outbound_details_id']);
