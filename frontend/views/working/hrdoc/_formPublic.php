...
//                'id' => 'form_receiveAsset'
    ...
    <div class="form-row">
        <div class="col-sm-12 col-lg-6 pb-3">
            ...
            <?php
            $data = \frontend\models\working\hrdoc\HrPublicDocuments::find()
    ...
    <div class="form-row">
        ...
        <div class="col-sm-12 col-lg-3 pb-3">
            <?=
            common\models\myTools\MyCommonFunction::activeFormDateInput($form, $model, 'file_date', "File Date");
            ?>
        </div>
    </div>
    ...
    <!--<div class="form-row">-->
        <!--<div class="col-sm-12 col-lg-3 pb-3">-->
            <?php
//            =
//            $form->field($model, 'show_alert')->dropDownList([
//                '' => 'Select...',
//                '0' => 'No',
//                '1' => 'Yes'
//            ])
