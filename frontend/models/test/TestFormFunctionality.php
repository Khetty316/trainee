...
/**
 * This is the model class for table "test_form_functionality".
 *
 * @property int $id
 ...
 */
class TestFormFunctionality extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'test_form_functionality';
    }
    ...
    public function getTestDetailFunctionalities() {
        return $this->hasMany(TestDetailFunctionality::class, ['form_functionality_id' => 'id']);
    }
    ...
    public static function addForm($id) {
        $model = new TestFormFunctionality();
