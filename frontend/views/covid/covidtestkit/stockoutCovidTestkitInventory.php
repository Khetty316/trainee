...
$this->title = 'Covid-19 Test-Kit Stock Out';
...
//                        ->select(['brand'])
        ...
        <div class="form-group row">
            <div class="col-xs-12 col-md-3">
                <?= $form->field($model, 'giving_to')->dropdownList(common\models\User::getActiveDropDownList(), ['prompt' => '(Select...)'])->label("Given to") ?> 
            </div>
        </div>
        <div class="form-group row">
            <div class="col-xs-12 col-md-3">
        ...
        <div class="form-group row">
            <div class="col-xs-12 col-md-3">
                <?= $form->field($model, 'total_movement')->textInput(["type" => "number", "min" => 1])->label("Total") ?>
            </div>
        </div>
