                ...
                foreach ($invoices as $key => $inv) {
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <p class="p-0 m-0">
                                <?php
                                echo $inv->currency0->currency_sign . " " . MyFormatter::asDecimal2_emptyDash($inv->getTotalAmount_byProject($projCode)) . " (Total: " . (MyFormatter::asDecimal2_emptyDash($inv->getTotalAmount())) . ")";
                                ?>
                            </p>
                        </td>
