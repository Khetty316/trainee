...
<div class="master-incomings-index">
    ...
    <p>
        <?php
        echo Html::a(
                'Received <i class="fas fa-download"></i>', "#",
                ['class' => 'btn btn-success', 'onclick' => 'checkCheckBoxes()']
        )
        ?>
...
<?php echo $this->render('_checkboxModal', ['action' => '/working/mi/procreceiveddoc', 'title' => 'Receive Document?']); ?>
