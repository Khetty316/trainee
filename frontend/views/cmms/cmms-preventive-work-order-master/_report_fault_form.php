    ...
    <div class="card-header bg-light d-flex justify-content-between align-items-center flex-wrap">
        <div>
            ...
            <small class="text-muted">
                Created on: <?= $faultModel->reported_at; ?>
...
<!--                <? Html::activeHiddenInput(
                ...
                <tr>
                    <td>
                        ...
                        <?= Html::activeHiddenInput($faultModel, "fault_asset_id") ?>
...
<!--                        <? yii\helpers\Html::a(
                                ...
                                'javascript:void(0);',
                                [
                                    'class' => 'modalButtonSingle btn btn-sm btn-success view-asset-btn', 
...
<!--                            <?  
                    ...
                    //                        'data-key' => $key,
                        ...
                        <!--<php else: ?>-->
                            <?=  
                                $form->field($faultModel, "fault_type")->dropDownList(
                    ...
                    <td>
                        <?php if (!$isUpdate): ?>
                            <?=
                                $form->field($faultModel, "fault_primary_detail")->dropDownList(
                                        [],
                                        [
                                            'id' => 'primary-dropdown',
                //                            'data-key' => $key,
                        ...
                        <?php else: ?>
                            <?php if ($moduleIndex === 'superior'): ?>
                                <?= Html::encode(
                                    CmmsAssetList::getPrimaryFault_by_type($faultModel->fault_type)[$faultModel->fault_primary_detail] ?? '-'
                                ) ?>
                                <?= Html::activeHiddenInput(
                                    $faultModel,
                            ...
                            <?=
                                $form->field($faultModel, "fault_primary_detail")->dropDownList(
                                    CmmsAssetList::getPrimaryFault_by_type($faultModel->fault_type),
                                        [
                                            'id' => 'primary-dropdown',
                //                            'data-key' => $key,
                                            'prompt' => 'Select Primary Fault'
                    ...
                    <td>
                        <?php if (!$isUpdate): ?>
                            <?= 
                                $form->field($faultModel, "fault_secondary_detail")->dropDownList(
                                        [],
                                        [
                        ...
                        <?php if ($moduleIndex === 'superior'): ?>
                                <?= Html::encode(
                                    CmmsAssetList::getSecondaryFault($faultModel->fault_primary_detail)[$faultModel->fault_secondary_detail] ?? '-'
                                ) ?>
                                <?= Html::activeHiddenInput(
                                    $faultModel,
                            ...
                            <?=
                                $form->field($faultModel, "fault_secondary_detail")->dropDownList(
                                      CmmsAssetList::getSecondaryFault($faultModel->fault_primary_detail)  
                                )->label(false);
                            ?>
                        <?php endif; ?>
                        <?php endif; ?>
                    ...
                    <td>
                        ...
                        ?>
                        <?= 
                            $form->field($faultModel, "machine_priority_id")->dropDownList(
                                $priorityList
                            )->label(false); 
                        ?>
                    </td>
...
<!--                        <php if (!empty($model->machinePhotos)): ?>
                        ...
                        <div class="existing-photos" data-key="<?= $key ?>">
                            ...
                            <?php foreach ($faultModel->cmmsMachinePhotos as $photo): ?>
...
<!--                        <? Html::encode($model->additional_remarks); ?>
                        ...
                        <!--<php else: ?>-->
                        <?=
                            $form->field($faultModel, "additional_remarks")->textarea()->label(false);
                        ?>
                        <!--<php endif; ?>-->
                    </td>
        </tr>
                ...
                <?=
                    Html::submitButton('Save', [
                        ...
                        'onclick' => "return confirm('Are you sure you want to submit the fault report?');"
                    ])
                ?>
            <?php ActiveForm::end(); ?>
        </div>
...
//    });
    ...
    $(document).on('click', '#view-asset-btn', function (e) {
        ...
        $.get('<?= Url::to(['cmms/cmms-fault-list/view-asset-details']) ?>', {
