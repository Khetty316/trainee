...
<div class="work-assignment-master-form">
    ...
    <div class="work-assignment-master-form">
        ...
        $form = ActiveForm::begin([
            ...
            'action' => ['checking-tasks-assignment', 'projectId' => $project->id],
        ]);
        ?>
                ...
                <div class="form-row">
                    <div class="col-sm-12 col-md-5">
                        <fieldset class="form-group border p-3">
                            <legend class="w-auto px-2 m-0">Selected Panel(s):</legend>
                            <table class="table table-sm table-striped table-bordered">
                                <?php
                                foreach ($panels as $key => $panel) {
                                    echo '<tr><td>' . $panel->project_production_panel_code . '</td></tr>';
                                }
                                ?>
                            </table>
                        </fieldset>
                        ...
                        <fieldset class="border p-1">
                            ...
                            <div class="row">
                                <div class="col-md-5 col-sm-12">
                                    ...
                                    <div class="col-12">
                                        <?php
                                        echo $form->field($model, 'panelIds', ['options' => ['class' => 'hidden']]);
                                            ...
                                            foreach ((array) $taskList as $key => $task) {
                                                ...
                                                <tr><td class="p-2">
                                                    ...
                                                    <td class="text-center">
                                                        <?php
                                                        echo Html::checkbox('TaskAssignment[taskCode][]', null, ['value' => $task->code, 'class' => 'form-control form-control-sm taskCheckBox']);
                                                        ?>
                                                    </td></tr>
                                                <?php
                                            }
...
//                                }
                                ?>
                                <?php
                                $refTaskElec = frontend\models\ProjectProduction\electrical\RefProjProdTaskElec::find()
                                        ->orderBy(['sort' => SORT_ASC])
                                        ->all();
                                $staffListWithTaskType = \frontend\models\projectproduction\task\WorkerTaskCategories::find()
                                        ->where(['task_type' => frontend\models\projectproduction\task\TaskAssignment::taskTypeElectrical])
                                        ->all();
                                ...
                                $orderedTaskCodes = [];
                                foreach ($refTaskElec as $taskElec) {
                                    if ($taskElec->active_sts == 1) { // Only active tasks
                                        $orderedTaskCodes[] = [
                                            'code' => $taskElec->code,
                                            'name' => $taskElec->name,
                                            'sort' => $taskElec->sort,
                                            'weight' => $taskElec->weight
                                        ];
                                    }
                                }
