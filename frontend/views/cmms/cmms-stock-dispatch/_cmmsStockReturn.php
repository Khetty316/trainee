...
<div class="cmms-stock-detail">
    <?php
    $form = ActiveForm::begin([
                'id' => 'myForm',
                'method' => 'post',
                'action' => yii\helpers\Url::to(['return-dispatched-quantity', 'dispatchId' => $dispatchMaster->dispatch_id, 'detailId' => $dispatchMaster->request_detail_id]),
    ]);
    ?>
            ...
            <fieldset class="border p-1">
                ...
                <div class="row mb-2">
                    <div class="col-lg-6 col-md-12 col-sm-12">
                        ...
                        <input type="hidden" name="dispatch[detail_id]" class="form-control form-control-sm" value="<?= $dispatchMaster->request_detail_id ?>" />
