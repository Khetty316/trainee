...
/**
 * This is the model class for table "v_fab_staff_production".
 *
 * @property int $id
 ...
 * @property float|null $panel_fab_assign_percent
 * @property float|null $panel_fab_complete_percent
 * @property string|null $panel_fab_completed_at
 * @property int|null $panel_fab_completed_by
 * @property string|null $filename
 */
class VFabStaffProduction extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['created_at', 'updated_at', 'assigned_start_date', 'assigned_start_date_individual', 'assigned_complete_date', 'assigned_complete_date_individual', 'deactivated_at', 'panel_finalized_at', 'panel_fab_completed_at'], 'safe'],
            [['assigned_qty', 'assigned_complete_qty', 'assigned_complete_qty_individual', 'taskToDo_total_qty', 'taskToDo_assigned_qty', 'panel_fab_assign_percent', 'panel_fab_complete_percent'], 'number'],
    ...
    public function attributeLabels() {
        return [
            ...
            'panel_fab_assign_percent' => 'Panel Fab Assign Percent',
            'panel_fab_complete_percent' => 'Panel Fab Complete Percent',
            'panel_fab_completed_at' => 'Panel Fab Completed At',
            'panel_fab_completed_by' => 'Panel Fab Completed By',
            'filename' => 'Filename',
        ];
    }
    ...
    public function getTaskAssignFabCompletes() {
        return $this->hasMany(TaskAssignFabComplete::class, ['task_assign_fab_id' => 'taskAssignment_id']);
    }
