                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li class="dropdown dropright pl-0">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <?php
                                            if ($thisUser->can($proc) || $thisUser->can($acc) || $thisUser->can($admin) || $thisUser->can($hr)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('<i class="far fa-plus-square"></i> New Incoming Registration', '/working/mi/index'));
                                            }
                                            if ($thisUser->can($isStaff)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('Requestor Review <i class="fas fa-mobile-alt fa-pull-right"></i>', '/working/mi/requestorreview'));
                                            }
                                            if ($thisUser->can($admin)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('Admin Dept.', '/working/mi/adminactiverecord'));
                                            }

                                            if ($thisUser->can($proc)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                            ...
                                            if ($thisUser->can($directors)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('Director <i class="fas fa-mobile-alt fa-pull-right"></i>', '/working/mi/directorreview'));
                                            }
                                            ?>
                                        </ul>
                                    </li>
                                    <li class="dropdown dropright pl-0">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <?php
                                            if ($thisUser->identity->is_leave_superior == 1 || $thisUser->can($directors)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                    ...
                                    <li class="dropdown dropright pl-0">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <?php
                                            echo yii\bootstrap4\Html::tag('li',
                                                    Html::a('Authorize Claim', '/working/claim/authorize-claim'));
                                            if ($thisUser->can($hr) || $thisUser->can($acc)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('Master Claim List', '/working/claim/hr-submitted-claim'));
                                            }
                                            if ($thisUser->can($hr)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('HR - Travel Claim', '/working/claim/hr-travel-claim'));
                                            }
                                            if ($thisUser->can($directors)) {
                                                echo yii\bootstrap4\Html::tag('li',
                                                        Html::a('Special Approval', '/working/leavemgmt/director-leave-approval'));
                                            }
                                            ?>
                                        </ul>
                                    </li>
                        ...
                        <ul class="navbar-nav mr-1">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <?php
                                    echo yii\bootstrap4\Html::tag('li',
                                            Html::a('<i class="far fa-id-card"></i>&nbsp;&nbsp;&nbsp;User Profile', '/profile/view-profile?id=' . $thisUser->identity->id, ['class' => 'pl-4'])
                                            , ['class' => 'pl-0']);
                                    ?>
