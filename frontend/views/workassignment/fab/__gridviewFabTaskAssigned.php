    ...
    'columns' => [
        ...
        [
            ...
            'value' => function ($model) {
                ...
                return Html::a($projCode, ['index-fab-project-panels', 'id' => $project->id]) . $panelCode;
            }
        ],
        [
            'attribute' => 'taskCode',
            'filter' => \frontend\models\ProjectProduction\fabrication\RefProjProdTaskFab::getDropDownList(),
            'format' => 'raw',
            'value' => function ($model) {
                return $model->prodFabTask->fabTaskCode->name ?? null;
            }
        ],
        [
            'attribute' => 'quantity',
