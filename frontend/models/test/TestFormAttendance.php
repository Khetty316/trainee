...
/**
 * This is the model class for table "test_form_attendance".
 *
 * @property int $id
 ...
 * @property TestDetailAttendance[] $testDetailAttendances
 * @property TestMaster $testMaster
 */
class TestFormAttendance extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'test_form_attendance';
    }
    ...
    /**
     * Gets query for [[TestDetailAttendances]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getTestDetailAttendances() {
        return $this->hasMany(TestDetailAttendance::class, ['form_attendance_id' => 'id']);
    }
