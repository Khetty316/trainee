...
$moduleConfigs = [
    'execStock' => [
        ...
        '5' => ['name' => 'Material Reservation', 'link' => '/inventory/inventory/reserved-item-list?type=execStock'],
        '6' => ['name' => 'Material Requisition', 'link' => '/inventory/inventory/material-request-list?type=execStock'],
        '7' => ['name' => 'Component Usage', 'link' => '/inventory/inventory/component-usage-list?type=execStock'],
    ],
    'assistStock' => [
        ...
        '5' => ['name' => 'Material Reservation', 'link' => '/inventory/inventory/reserved-item-list?type=assistStock'],
    ],
    'projcoorStock' => [
        ...
        '5' => ['name' => 'Material Reservation', 'link' => '/inventory/inventory/reserved-item-list?type=projcoorStock'],
    ],
    'maintenanceHeadStock' => [
        ...
        '5' => ['name' => 'Material Reservation', 'link' => '/inventory/inventory/reserved-item-list?type=maintenanceHeadStock'],
        '6' => ['name' => 'Material Requisition', 'link' => '/inventory/inventory/material-request-list?type=maintenanceHeadStock'],
        '7' => ['name' => 'Component Usage', 'link' => '/inventory/inventory/component-usage-list?type=maintenanceHeadStock'],
    ],
    'personalStock' => [
        '1' => ['name' => 'Item List', 'link' => '/inventory/inventory/item-list?type=personalStock'],
        '2' => ['name' => 'Material Requisition', 'link' => '/inventory/inventory/material-request-list?type=personalStock'],
    ],
    'execPurchasing' => [
        '1' => [
