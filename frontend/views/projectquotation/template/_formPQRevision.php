...
<div class="project-qrevisions-template-form">
    ...
    <div class="form-row">
        <div class="col-sm-12 col-md-5">
            <?= $form->field($model, 'revision_description')->textInput(['maxlength' => true, 'readonly' => true]) ?>
        </div>
        <div class="col-sm-12 col-md-5">
    ...
    <div class="form-row">
        <div class="col-sm-12 col-md-2">
            <?= $form->field($model, 'with_sst')->dropDownList(['1' => 'Yes', '0' => 'No']) ?>
        </div>
        <div class="col-sm-12 col-md-2">
            <?= $form->field($model, 'show_breakdown')->dropDownList(['1' => 'Yes', '0' => 'No']) ?>
        </div>
    </div>
