...
/**
 * This is the model class for table "task_assign_fab_complete".
 *
 * @property int $id
 ...
 */
class TaskAssignFabComplete extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'task_assign_fab_complete';
    }
    ...
    public function rules() {
        return [
            ...
            [['quantity', 'task_assign_fab_id'], 'required'],
            [['task_assign_fab_id', 'created_by'], 'integer'],
            [['quantity'], 'number'],
            [['complete_date', 'created_at'], 'safe'],
            [['comment'], 'string', 'max' => 255],
            [['task_assign_fab_id'], 'exist', 'skipOnError' => true, 'targetClass' => TaskAssignFab::class, 'targetAttribute' => ['task_assign_fab_id' => 'id']],
    ...
    public function getTaskAssignFab() {
        return $this->hasOne(TaskAssignFab::class, ['id' => 'task_assign_fab_id']);
    }
