...
$totalSSTAmount = 0;
$isDisabled = QuotationPdfMasters::find()
...
.option-title {
    ...
    color: #333;
                                            ...
                                            ?>
                                            <?php if (!$finalized): ?>
                                                <?php if ((Yii::$app->user->can(AuthItem::ROLE_Director) || Yii::$app->user->id == $theQuotation['0']->created_by) && $theQuotation['0']->md_approval_status !== QuotationPdfMasters::QUOTATION_DIRECTOR_APPROVED): ?>
                                                    <?=
                                ...
                                <tr id="tr_<?= $panel->id ?>">
                                    ...
                                    <td style=""> 
                                        ...
                                        Html::a($panel->panel_description,
                                                ...
                                                ['title' => 'View', 'class' => 'mx-1 text-primary no-text-deco ' . ($isDisabled ? 'disabled-link' : '')])
                                        ?>
...
<script>
    ...
    function validateAndGetApproval() {
        ...
        // Move console.log AFTER populating the array
        console.log('Checked quotations:', checkedQuotations);
        console.log('Number of checked items:', checkedQuotations.length);
