                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            if (MyCommonFunction::checkRoles([AuthItem::ROLE_Director, AuthItem::ROLE_ProjCoordinator, AuthItem::ROLE_SystemAdmin,
                                ...
                                $menuQuotation = MenuModel::newMenuItems('<i class="fas fa-clipboard-list"></i>', 'Quotation Management', '#');
                                $menuQuotation->children[] = MenuModel::newMenuItems('', 'Quotations', '/projectquotation');
                                $menuQuotation->children[] = MenuModel::newMenuItems('', 'Quotation Template', '/projectqtemplate/indexpqrevision');
                                if (MyCommonFunction::checkRoles([AuthItem::ROLE_Director, AuthItem::ROLE_SystemAdmin])) {
                                    $menuQuotation->children[] = MenuModel::newMenuItems('', 'Quotation Approval - Director', '/projectquotation/director-pending-approval');
                                }
                            ...
                            if (MyCommonFunction::checkRoles([AuthItem::ROLE_Director, AuthItem::ROLE_ProjCoordinator, AuthItem::ROLE_SystemAdmin])) {
                                $menuProduction = MenuModel::newMenuItems('<i class="fas fa-hammer"></i>', 'Production Tracking', '#');
                                ...
                                $mainMenuItems[] = $menuProduction;
                            }

                            if (MyCommonFunction::checkRoles([AuthItem::ROLE_Director])) {
                                $mainMenuItems[] = MenuModel::newMenuItems('<i class="fas fa fa-percent"></i>', 'Task Weight', '/production/production/index-production-project-list');
                            }
                            ...
                            if (MyCommonFunction::checkRoles([AuthItem::ROLE_PrdnElec_Executive, AuthItem::ROLE_PrdnFab_Executive, AuthItem::ROLE_Director, AuthItem::ROLE_ProjCoordinator, AuthItem::ROLE_SystemAdmin])) {
                                ...
                                $mainMenuItems[] = $menuTaskAssignment;
                            }
                            ...
                            if (true) {
                                ...
                                $mainMenuItems[] = $menuTesting;
                            }
                            ?>

                            <li class="dropdown">
                                <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-industry"></i>&nbsp;&nbsp;&nbsp;Projects
                                </a>
...
//                            }
                            ...
                            if (MyCommonFunction::checkRoles([AuthItem::Module_CMMS])) {
                                $menuReportPreventiveMaintenance = MenuModel::newMenuItems('<i class="fas fa-tools"></i>', 'CMMS', '/maintenance');
                                $mainMenuItems2[] = $menuReportPreventiveMaintenance;
                            }
