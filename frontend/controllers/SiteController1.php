...
//        $dateFrom = date('Y') . '-01-01';
        $dateFrom = date('Y') . '-' . date('m') . '-01'; // e.g., "2025-09-01"
        $model->dateTo = $dateTo;
        ...
        $fabPerformanceList_dept = $model->calculateDepartmentCompleteRecord($model, TaskAssignment::taskTypeFabrication);
        $elecPerformanceList_individual = $model->calculatePersonalCompleteRecord($model, TaskAssignment::taskTypeElectrical);
        $elecPerformanceList_dept = $model->calculateDepartmentCompleteRecord($model, TaskAssignment::taskTypeElectrical);
        ...
        //Top 3 Fabrication and Electrical Staff
