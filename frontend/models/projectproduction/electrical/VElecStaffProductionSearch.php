...
class VElecStaffProductionSearch extends VElecStaffProduction {
    ...
    public function rules() {
        return [
            ...
            [['created_at', 'updated_at', 'assignee_fullname', 'assigner_fullname', 'assigned_start_date', 'assigned_start_date_individual', 'assigned_complete_date', 'assigned_complete_date_individual', 'assigned_comments', 'deactivated_at', 'deactivated_by_fullname', 'task_name', 'panel_code', 'panel_description', 'panel_unit_code', 'panel_unit_name', 'panel_remark', 'panel_finalized_at', 'panel_elec_completed_at', 'filename'], 'safe'],
            [['assigned_current_target_date', 'assigned_qty', 'assigned_complete_qty', 'assigned_complete_qty_individual', 'taskToDo_total_qty', 'taskToDo_assigned_qty', 'panel_elec_assign_percent', 'panel_elec_complete_percent'], 'number'],
        ];
    }
    ...
    public function search($params, $type, $date = null) {
        $query = VElecStaffProduction::find();
