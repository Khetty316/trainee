...
/**
 * This is the model class for table "eh_outpatient_med_master".
 *
 * @property int $id
 ...
 */
class EhOutpatientMedMaster extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'eh_outpatient_med_master';
    }
    ...
    public function getEhOutpatientMedDetails() {
        return $this->hasMany(EhOutpatientMedDetail::className(), ['eh_outpatient_med_master_id' => 'id']);
    }
