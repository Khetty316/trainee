...
$this->params['breadcrumbs'][] = ['label' => 'Request For Quotation'];
$this->params['breadcrumbs'][] = ['label' => 'Pending', 'url' => ['staff-view-quotation-list-pending']];
...
if ($model->proc_approval == 1) {
    ...
    if ($quotationList) {
        ...
        <fieldset class="form-group border p-3">
            ...
            <?php
            if ($model->getReqApprovalSts() == $model::STS_REQ && $model->getProcApprovalSts() != $model::STS_PROC) {
                $form2 = ActiveForm::begin([
                            'options' => ['enctype' => 'multipart/form-data', 'autocomplete' => 'off'],
                            'action' => 'staff-action-forward-to-manager',
                            'method' => 'post',
                            'id' => 'reqQuotationForm'
                ]);
                ?>
                <div class="form-row">
                    <div class="col-xs-12 col-md-6">
                        <?= Html::textarea('requestor_remark', '', ['rows' => 6, 'placeholder' => 'Remark','class'=>'form-control my-2']) ?>
                    </div>
                </div>
                <div class="form-row mx-1">
                    ...
                    <div class='form-group'>
                        <?= Html::a('Approve, forward to Manager <i class="far fa-share-square"></i>', "javascript:submitRequest(1)", ['class' => 'btn btn-success submitButton', 'data-confirm' => 'Approve?']) ?> 
