    ...
    <div class="card-body p-2 table-responsive">
        <div class="cmms-fault-list-form table-responsive" id="fault-form-container">
            ...
            $form = ActiveForm::begin([
                ...
                'action' => ['/cmms/cmms-fault-list/bulk-update', 'moduleStatus' => $moduleStatus, 'module' => 'Corrective'],
                'method' => 'post',
            ]);
            ?>
...
//                                'data-back-url' => Url::to([
//                                    'cmms/cmms-fault-list/fault-form-modal', 
//                                    'id' => $model->id ?? null
//                                        ]),
                                            'aria-disabled' => 'true',
                                        ]
...
//                                ->label(false);
                            ...
                            <?php // foreach ($parts as $part):  ?>
                                    <!--<option value="<?php //= Html::encode($part['name'])   ?>"-->
                                            <!--data-id="<?php //= $part['id']   ?>">-->
                            <?php // endforeach; ?>
                            <!--</datalist>-->
    <!--                            <? 
...
//                                    ->scalar();
                            ?>
                            <?php //= Html::encode($partListDetails->name)  ?>
                            <?php // endif;  ?>
...
//                                ->label(false);
    ...
    <!--                                    <option value="<?php //= Html::encode($tool['name'])  ?>"
                                            data-id="<?php //= $tool['id']  ?>">-->
                            <?php // endforeach; ?>
                            <!--</datalist>-->
    <!--                            <? 
                            ...
                            <td>
                                <?php if ($moduleStatus === 'superior'): ?>
                                    ...
                                    $displayName = !empty($placeholder) ?
                                            $placeholder : User::HEAD_OF_MAINTENANCE_NAME;
                                    ?>
                                    <?=
