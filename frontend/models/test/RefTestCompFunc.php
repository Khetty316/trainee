...
/**
 * This is the model class for table "ref_test_comp_func".
 *
 ...
 */
class RefTestCompFunc extends \yii\db\ActiveRecord {

    /**
     * {@inheritdoc}
     */
    public static function tableName() {
        return 'ref_test_comp_func';
    }
    ...
    public function getTestDetailComponents() {
        return $this->hasMany(TestDetailComponent::class, ['function_type' => 'code']);
    }
