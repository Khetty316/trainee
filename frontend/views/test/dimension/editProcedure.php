    ...
    <div class="form-row">
        <div class="col-md-12">
            ...
            if ($template) {
                ...
                <div class="form-row">
                    <div class="col-sm-12 col-md-12">
                        <?php //= $form->field($testTemplate, 'proctest2')->textarea(['class' => 'form-control proctest2', 'value' => isset($procedureValues[1]) ? $procedureValues[1] : '']) ?>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-sm-12 col-md-12">
                        <?php //= $form->field($testTemplate, 'proctest3')->textarea(['class' => 'form-control proctest3', 'value' => isset($procedureValues[2]) ? $procedureValues[2] : '']) ?>
                    </div>
                </div>
            <?php } else {
                ?>
                ...
                <div class="form-row">
                    <div class="col-sm-12 col-md-12">
                        <?php //= $form->field($procedures, 'proctest2')->textarea(['rows' => 8, 'class' => 'form-control proctest2']) ?>
                    </div>
                </div>
                <div class="form-row">
                    <div class="col-sm-12 col-md-12">
                        <?php //= $form->field($procedures, 'proctest3')->textarea(['rows' => 8, 'class' => 'form-control proctest3']) ?>
                    </div>
                </div>
            <?php } ?>
        </div>
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response.error) {
                                ...
                                // Optional: Show compression info
                                if (response.originalSize > 80 * 1024) {
                                    console.log('Image compressed from ' + Math.round(response.originalSize / 1024) + 'KB to ' +
                                            Math.round(response.compressedSize / 1024) + 'KB');
                                    console.log('Final dimensions: ' + response.dimensions);
                                }
                            }
                        },
                        error: function (error) {
